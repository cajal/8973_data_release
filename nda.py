...
class Treadmill(dj.Manual):
    ...
    ->RawTreadmill
    ---
    treadmill_velocities      : longblob                     # vector of treadmill velocities synchronized with field 1 frame times (cm/s)
    """
...
class FrameTimes(dj.Manual):
    ...
    ->Scan
    ---
    frame_times        : longblob            # scan frame times (len = nframes)
...
##TODO: check if its the same format as minnie
@schema
...
##TODO: ask stelios and jake where this table is 
##TODO: confirm if fluoro or deconvolved from EASE
@schema 
class EASE(dj.Manual):
    definition = """
...
##TODO: ease-analog of ScanUnit, no ms-delay
...
##TODO: find corresponding map-scan -> check if actually V1 -> widefield retinotopy
@schema 
